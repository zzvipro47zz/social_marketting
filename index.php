        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a><i class="fa fa-facebook-official" aria-hidden="true" style="margin-right: 5px"></i> Facebook<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a data-template="facebook.up-share" class="load-template">Up Share</a>
                            </li>
                            <li>
...
<script src="./assets/js/facebook/up-share.js"></script>
